        ...
        */
        ...
        FROM ( --               SyncObjectName                                            ImportTable                                 ImportProc                                              ImportType                                          ExportQueryPath                              ChecksumQueryText
            VALUES (-951091328, 'sys.dm_hadr_cluster'                       , 1, 1, 1440, 'dbo._dm_hadr_cluster'                    , NULL                                                  , NULL                                              , NULL                                       , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0)    FROM sys.dm_hadr_cluster;')
                ...
                ,  (-680277963, 'sys.database_query_store_options'          , 2, 1,  480, 'dbo._database_query_store_options'       , NULL                                                  , NULL                                              , NULL                                       , 'SELECT CHECKSUM_AGG(CHECKSUM(*))                 FROM sys.database_query_store_options;')
                ...
                ,  (      -598, 'sys.database_automatic_tuning_options'     , 2, 1,  480, NULL                                      , 'import.usp_import__database_automatic_tuning_options', 'import.import__database_automatic_tuning_options', 'sys.database_automatic_tuning_options.sql', 'SELECT CHECKSUM_AGG(CHECKSUM(*))                 FROM sys.database_automatic_tuning_options;')
                ...
                ,  (      -437, 'sys.filegroups'                            , 2, 1,  480, 'dbo._filegroups'                         , NULL                                                  , NULL                                              , NULL                                       , 'SELECT CHECKSUM_AGG(CHECKSUM(*))                 FROM sys.filegroups;')
                ,  (      -436, 'sys.data_spaces'                           , 2, 1,  480, 'dbo._data_spaces'                        , NULL                                                  , NULL                                              , NULL                                       , 'SELECT CHECKSUM_AGG(CHECKSUM(*))                 FROM sys.data_spaces;')
                ...
                ,  (      -410, 'sys.foreign_key_columns'                   , 2, 1,  480, NULL                                      , 'import.usp_import__foreign_key_columns'              , 'import.import__foreign_key_columns'              , 'sys.foreign_key_columns.sql'              , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0)    FROM sys.foreign_key_columns;') -- As of SQL Server 2022, there are no system computed columns
                ...
                ,  (      -252, 'sys.server_event_sessions'                 , 1, 1,  480, 'dbo._server_event_sessions'              , NULL                                                  , NULL                                              , NULL                                       , NULL)
                ...
                ,  (      -216, 'sys.master_files'                          , 1, 1,  480, NULL                                      , 'import.usp_import__master_files'                     , 'import.import__master_files'                     , 'sys.master_files.sql'                     , 'SELECT CHECKSUM_AGG(CHECKSUM(*))                 FROM sys.master_files;')
                ,  (      -213, 'sys.databases'                             , 1, 1,  480, NULL                                      , 'import.usp_import__databases'                        , 'import.import__databases'                        , 'sys.databases.sql'                        , 'SELECT CHECKSUM_AGG(CHECKSUM(*))                 FROM sys.databases;')
