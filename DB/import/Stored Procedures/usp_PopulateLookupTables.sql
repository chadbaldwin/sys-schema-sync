        ...
        */
        ...
        FROM ( --               SyncObjectName                                            ImportTable                                 ImportProc                                              ImportType                                          ExportQueryPath                              ChecksumQueryText
            VALUES (-951091328, 'sys.dm_hadr_cluster'                       , 1, 1, 1440, 'dbo._dm_hadr_cluster'                    , NULL                                                  , NULL                                              , NULL                                       , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0)    FROM sys.dm_hadr_cluster;')
                ,  (-897487264, 'sys.dm_xe_sessions'                        , 1, 1, 1440, 'dbo._dm_xe_sessions'                     , NULL                                                  , NULL                                              , NULL                                       , NULL)
                ,  (-879924562, 'sys.dm_db_log_space_usage'                 , 2, 1, 1440, 'dbo._dm_db_log_space_usage'              , NULL                                                  , NULL                                              , NULL                                       , NULL)
                ...
                ,  (-783733354, 'sys.dm_os_wait_stats'                      , 1, 1, 1440, NULL                                      , 'import.usp_import__dm_os_wait_stats'                 , 'import.import__dm_os_wait_stats'                 , NULL                                       , NULL)
                ,  (-680277963, 'sys.database_query_store_options'          , 2, 1, 1440, 'dbo._database_query_store_options'       , NULL                                                  , NULL                                              , NULL                                       , 'SELECT CHECKSUM_AGG(CHECKSUM(*))                 FROM sys.database_query_store_options;')
                ...
                ,  (-641734695, 'sys.dm_resource_governor_resource_pools'   , 1, 1, 1440, 'dbo._dm_resource_governor_resource_pools', NULL                                                  , NULL                                              , NULL                                       , NULL)
                ,  (-638989397, 'sys.dm_os_volume_stats'                    , 2, 1, 1440, 'dbo._dm_os_volume_stats'                 , NULL                                                  , NULL                                              , 'sys.dm_os_volume_stats.sql'               , NULL)
                ,  (-558058590, 'sys.dm_os_host_info'                       , 1, 1, 1440, 'dbo._dm_os_host_info'                    , NULL                                                  , NULL                                              , NULL                                       , 'SELECT CHECKSUM_AGG(CHECKSUM(*))                 FROM sys.dm_os_host_info;')
                ...
                ,  (-489165464, 'sys.dm_os_sys_memory'                      , 1, 1, 1440, 'dbo._dm_os_sys_memory'                   , NULL                                                  , NULL                                              , NULL                                       , NULL)
                ,  (-469313267, 'sys.dm_os_nodes'                           , 1, 1, 1440, 'dbo._dm_os_nodes'                        , NULL                                                  , NULL                                              , NULL                                       , NULL)
                ,  (-334110873, 'sys.dm_db_index_usage_stats'               , 2, 1, 1440, NULL                                      , 'import.usp_import__dm_db_index_usage_stats'          , 'import.import__dm_db_index_usage_stats'          , 'sys.dm_db_index_usage_stats.sql'          , NULL)
                ...
                ,  (-233577667, 'sys.dm_hadr_database_replica_states'       , 2, 1, 1440, 'dbo._dm_hadr_database_replica_states'    , NULL                                                  , NULL                                              , 'sys.dm_hadr_database_replica_states.sql'  , NULL)
                ,  (-215103612, 'sys.dm_os_sys_info'                        , 1, 1, 1440, 'dbo._dm_os_sys_info'                     , NULL                                                  , NULL                                              , NULL                                       , NULL)
                ,  (-129939010, 'sys.dm_os_enumerate_fixed_drives'          , 1, 1, 1440, 'dbo._dm_os_enumerate_fixed_drives'       , NULL                                                  , NULL                                              , NULL                                       , NULL)
                ,  ( -46687631, 'sys.dm_os_memory_nodes'                    , 1, 1, 1440, 'dbo._dm_os_memory_nodes'                 , NULL                                                  , NULL                                              , NULL                                       , NULL)
                ...
                ,  ( -32276936, 'sys.dm_os_process_memory'                  , 1, 1, 1440, 'dbo._dm_os_process_memory'               , NULL                                                  , NULL                                              , NULL                                       , NULL)
                ,  (      -598, 'sys.database_automatic_tuning_options'     , 2, 1, 1440, NULL                                      , 'import.usp_import__database_automatic_tuning_options', 'import.import__database_automatic_tuning_options', 'sys.database_automatic_tuning_options.sql', 'SELECT CHECKSUM_AGG(CHECKSUM(*))                 FROM sys.database_automatic_tuning_options;')
                ...
                ,  (      -448, 'sys.database_files'                        , 2, 1, 1440, 'dbo._database_files'                     , NULL                                                  , NULL                                              , NULL                                       , NULL)
                ,  (      -437, 'sys.filegroups'                            , 2, 1, 1440, 'dbo._filegroups'                         , NULL                                                  , NULL                                              , NULL                                       , 'SELECT CHECKSUM_AGG(CHECKSUM(*))                 FROM sys.filegroups;')
                ,  (      -436, 'sys.data_spaces'                           , 2, 1, 1440, 'dbo._data_spaces'                        , NULL                                                  , NULL                                              , NULL                                       , 'SELECT CHECKSUM_AGG(CHECKSUM(*))                 FROM sys.data_spaces;')
                ...
                ,  (      -412, 'sys.triggers'                              , 2, 1, 1440, NULL                                      , 'import.usp_import__triggers'                         , 'import.import__triggers'                         , 'sys.triggers.sql'                         , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0)    FROM sys.triggers               WHERE is_ms_shipped = 0;')
                ,  (      -410, 'sys.foreign_key_columns'                   , 2, 1, 1440, NULL                                      , 'import.usp_import__foreign_key_columns'              , 'import.import__foreign_key_columns'              , 'sys.foreign_key_columns.sql'              , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0)    FROM sys.foreign_key_columns;') -- As of SQL Server 2022, there are no system computed columns
                ,  (      -409, 'sys.foreign_keys'                          , 2, 1, 1440, NULL                                      , 'import.usp_import__foreign_keys'                     , 'import.import__foreign_keys'                     , 'sys.foreign_keys.sql'                     , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0)    FROM sys.foreign_keys           WHERE is_ms_shipped = 0;')
                ,  (      -408, 'sys.default_constraints'                   , 2, 1, 1440, NULL                                      , 'import.usp_import__default_constraints'              , 'import.import__default_constraints'              , 'sys.default_constraints.sql'              , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0)    FROM sys.default_constraints    WHERE is_ms_shipped = 0;')
                ,  (      -407, 'sys.check_constraints'                     , 2, 1, 1440, NULL                                      , 'import.usp_import__check_constraints'                , 'import.import__check_constraints'                , 'sys.check_constraints.sql'                , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0)    FROM sys.check_constraints      WHERE is_ms_shipped = 0;')
                ,  (      -406, 'sys.key_constraints'                       , 2, 1, 1440, NULL                                      , 'import.usp_import__key_constraints'                  , 'import.import__key_constraints'                  , 'sys.key_constraints.sql'                  , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0)    FROM sys.key_constraints        WHERE is_ms_shipped = 0;')
                ,  (      -402, 'sys.stats'                                 , 2, 1, 1440, NULL                                      , 'import.usp_import__stats'                            , 'import.import__stats'                            , 'sys.stats.sql'                            , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0)    FROM sys.stats x                WHERE EXISTS (SELECT * FROM sys.objects o WHERE o.[object_id] = x.[object_id] AND o.is_ms_shipped = 0) AND x.auto_created = 0;')
                ,  (      -401, 'sys.index_columns'                         , 2, 1, 1440, NULL                                      , 'import.usp_import__index_columns'                    , 'import.import__index_columns'                    , 'sys.index_columns.sql'                    , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0)    FROM sys.index_columns x        WHERE EXISTS (SELECT * FROM sys.objects o WHERE o.[object_id] = x.[object_id] AND o.is_ms_shipped = 0);')
                ,  (      -399, 'sys.partitions'                            , 2, 1, 1440, NULL                                      , 'import.usp_import__partitions'                       , 'import.import__partitions'                       , 'sys.partitions.sql'                       , NULL)
                ,  (      -397, 'sys.indexes'                               , 2, 1, 1440, NULL                                      , 'import.usp_import__indexes'                          , 'import.import__indexes'                          , 'sys.indexes.sql'                          , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0)    FROM sys.indexes x              WHERE EXISTS (SELECT * FROM sys.objects o WHERE o.[object_id] = x.[object_id] AND o.is_ms_shipped = 0);')
                ,  (      -396, 'sys.identity_columns'                      , 2, 1, 1440, NULL                                      , 'import.usp_import__identity_columns'                 , 'import.import__identity_columns'                 , 'sys.identity_columns.sql'                 , NULL) -- There will almost definitely always be changes because this table stores the last identity value
                ,  (      -395, 'sys.computed_columns'                      , 2, 1, 1440, NULL                                      , 'import.usp_import__computed_columns'                 , 'import.import__computed_columns'                 , 'sys.computed_columns.sql'                 , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0)    FROM sys.computed_columns;')    -- As of SQL Server 2022, there are no system computed columns
                ...
                ,  (      -387, 'sys.views'                                 , 2, 1, 1440, NULL                                      , 'import.usp_import__views'                            , 'import.import__views'                            , 'sys.views.sql'                            , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0)    FROM sys.views                  WHERE is_ms_shipped = 0;')
                ,  (      -386, 'sys.tables'                                , 2, 1, 1440, NULL                                      , 'import.usp_import__tables'                           , 'import.import__tables'                           , 'sys.tables.sql'                           , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM([name], [object_id], principal_id, [schema_id], parent_object_id, [type], is_published, is_schema_published, lob_data_space_id, filestream_data_space_id, max_column_id_used, lock_on_bulk_load, uses_ansi_nulls, is_replicated, has_replication_filter, is_merge_published, is_sync_tran_subscribed, has_unchecked_assembly_data, text_in_row_limit, large_value_types_out_of_row, is_tracked_by_cdc, [lock_escalation], is_filetable, is_memory_optimized, [durability], temporal_type, history_table_id, is_remote_data_archive_enabled, is_external, history_retention_period, history_retention_period_unit, is_node, is_edge)), 0)
                ...
                ,  (      -252, 'sys.server_event_sessions'                 , 1, 1, 1440, 'dbo._server_event_sessions'              , NULL                                                  , NULL                                              , NULL                                       , NULL)
                ,  (      -224, 'sys.configurations'                        , 1, 1, 1440, NULL                                      , 'import.usp_import__configurations'                   , 'import.import__configurations'                   , 'sys.configurations.sql'                   , 'SELECT CHECKSUM_AGG(CHECKSUM(*))                 FROM sys.configurations;')
                ,  (      -216, 'sys.master_files'                          , 1, 1, 1440, NULL                                      , 'import.usp_import__master_files'                     , 'import.import__master_files'                     , 'sys.master_files.sql'                     , 'SELECT CHECKSUM_AGG(CHECKSUM(*))                 FROM sys.master_files;')
                ,  (      -213, 'sys.databases'                             , 1, 1, 1440, NULL                                      , 'import.usp_import__databases'                        , 'import.import__databases'                        , 'sys.databases.sql'                        , 'SELECT CHECKSUM_AGG(CHECKSUM(*))                 FROM sys.databases;')
                ,  (         1, 'SERVERPROPERTY'                            , 1, 1, 2880, 'dbo._SERVERPROPERTY'                     , NULL                                                  , NULL                                              , 'SERVERPROPERTY.sql'                       , NULL)
                ,  (         2, 'DATABASEPROPERTYEX'                        , 2, 1, 2880, 'dbo._DATABASEPROPERTYEX'                 , NULL                                                  , NULL                                              , 'DATABASEPROPERTYEX.sql'                   , NULL)
                ...
                ,  (         8, 'OBJECTPROPERTYEX'                          , 2, 1, 1440, NULL                                      , 'import.usp_import__OBJECTPROPERTYEX'                 , 'import.import__OBJECTPROPERTYEX'                 , 'OBJECTPROPERTYEX.sql'                     , NULL)
                ,  (         9, 'missing_indexes'                           , 2, 1,  360, NULL                                      , 'import.usp_import__missing_indexes'                  , 'import.import__missing_indexes'                  , 'missing_indexes.sql'                      , NULL)
