        ...
        */
        ...
        FROM ( --               SyncObjectName                                            ImportTable                                 ImportProc                                              ImportType                                          ExportQueryPath                              ChecksumQueryText
            VALUES (-951091328, 'sys.dm_hadr_cluster'                       , 1, 1, 1440, 'dbo._dm_hadr_cluster'                    , NULL                                                  , NULL                                              , NULL                                       , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0)    FROM sys.dm_hadr_cluster;')
                ...
                ,  (-644579219, 'sys.dm_db_stats_properties'                , 2, 1,  720, NULL                                      , 'import.usp_import__dm_db_stats_properties'           , 'import.import__dm_db_stats_properties'           , 'sys.dm_db_stats_properties.sql'           , NULL)
                ...
                ,  (-469313267, 'sys.dm_os_nodes'                           , 1, 1,  720, 'dbo._dm_os_nodes'                        , NULL                                                  , NULL                                              , NULL                                       , NULL)
