        ...
        */
        ...
        FROM ( --               SyncObjectName                                         ImportTable                                 ImportProc                                              ExportQueryPath                              ChecksumQueryText
            VALUES (-951091328, 'sys.dm_hadr_cluster'                       , 1, 1440, 'dbo._dm_hadr_cluster'                    , NULL                                                  , NULL                                       , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0) FROM sys.dm_hadr_cluster;')
                ...
                ,  (-305100784, 'sys.dm_server_services'                    , 1, 1440, NULL                                      , 'import.usp_import__dm_server_services'               , 'sys.dm_server_services.sql'            , NULL)
                ...
                ,  (      -426, 'sys.database_principals'                   , 2,  480, NULL                                      , 'import.usp_import__database_principals'              , 'sys.database_principals.sql'              , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0) FROM sys.database_principals;')
                ,  (      -416, 'sys.sql_modules'                           , 2, 1440, NULL                                      , 'import.usp_import__sql_modules'                      , 'sys.sql_modules.sql'                      , '/* To get around time zone offset discrepancies, just back up by one day
                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                         OPTION (RECOMPILE);')
                ,  (      -415, 'sys.trigger_events'                        , 2,  480, NULL                                      , 'import.usp_import__trigger_events'                   , 'sys.trigger_events.sql'                   , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0) FROM sys.trigger_events x    WHERE EXISTS (SELECT * FROM sys.triggers t WHERE t.[object_id] = x.[object_id] AND t.is_ms_shipped = 0);')
                ...
                ,  (      -393, 'sys.parameters'                            , 2, 1440, NULL                                      , 'import.usp_import__parameters'                       , 'sys.parameters.sql'                       , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0) FROM sys.parameters x        WHERE EXISTS (SELECT * FROM sys.objects o WHERE o.[object_id] = x.[object_id] AND o.is_ms_shipped = 0);')
                ...
                ,  (      -217, 'sys.server_principals'                     , 1,  480, NULL                                      , 'import.usp_import__server_principals'                , 'sys.server_principals.sql'                , 'SELECT COALESCE(CHECKSUM_AGG(CHECKSUM(*)), 0) FROM sys.server_principals;')
                ...
                ,  (         1, 'SERVERPROPERTY'                            , 1,  480, NULL                                      , 'import.usp_import__SERVERPROPERTY'                   , 'SERVERPROPERTY.sql'                       , NULL)
