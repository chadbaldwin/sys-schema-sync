CREATE TYPE import.import__identity_columns AS TABLE (
    ...
    seed_value                          bigint            NULL, -- Deviation: Original data type: sql_variant
    increment_value                     bigint            NULL, -- Deviation: Original data type: sql_variant
    last_value                          bigint            NULL, -- Deviation: Original data type: sql_variant
