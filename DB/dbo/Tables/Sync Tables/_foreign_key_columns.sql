CREATE TABLE dbo._foreign_key_columns (
    ...
    _ObjectID            bigint     NOT NULL CONSTRAINT FK__foreign_key_columns__ObjectID           REFERENCES dbo.[Object]   (_ObjectID)   INDEX IX__foreign_key_columns__ObjectID,
    ...
    INDEX CIX__foreign_key_columns__DatabaseID__ObjectID_constraint_column_id
        UNIQUE CLUSTERED (_DatabaseID, _ObjectID, constraint_column_id),
);
GO