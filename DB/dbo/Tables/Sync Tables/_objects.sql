CREATE TABLE dbo._objects (
    _DatabaseID         int             NOT NULL CONSTRAINT FK__objects__DatabaseID REFERENCES dbo.[Database]   (DatabaseID),
    _ObjectID           int             NOT NULL CONSTRAINT FK__objects__ObjectID   REFERENCES dbo.[Object]     (ObjectID),
