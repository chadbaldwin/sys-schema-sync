CREATE TABLE dbo._dm_xe_sessions (
	_InstanceID					int				NOT NULL CONSTRAINT FK__dm_xe_sessions__InstanceID REFERENCES dbo.[Instance] (_InstanceID),
	...
	total_target_memory			bigint				NULL, -- Added: SQL Server 2019 - Deviation: NOT NULL
