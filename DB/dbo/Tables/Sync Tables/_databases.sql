CREATE TABLE dbo._databases (
    _InstanceID                                int              NOT NULL CONSTRAINT FK__databases__InstanceID REFERENCES dbo.Instance   (_InstanceID),
    _DatabaseID                                int                  NULL CONSTRAINT FK__databases__DatabaseID REFERENCES dbo.[Database] (_DatabaseID),
    --
