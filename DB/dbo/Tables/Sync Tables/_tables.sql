CREATE TABLE dbo._tables (
    _DatabaseID                         int             NOT NULL CONSTRAINT FK__tables__DatabaseID  REFERENCES dbo.[Database]   (DatabaseID),
    _ObjectID                           int             NOT NULL CONSTRAINT FK__tables__ObjectID    REFERENCES dbo.[Object]     (ObjectID),
