...
CREATE TABLE dbo._tables_history (
    ...
    INDEX CIX__tables_history__ValidTo__ValidFrom CLUSTERED (_ValidTo, _ValidFrom) WITH (DATA_COMPRESSION = PAGE),
);
GO

CREATE TABLE dbo._tables (
    _DatabaseID                        int           NOT NULL CONSTRAINT FK__tables__DatabaseID REFERENCES dbo.[Database] (_DatabaseID) INDEX IX__tables__DatabaseID,
    _ObjectID                          bigint        NOT NULL CONSTRAINT FK__tables__ObjectID   REFERENCES dbo.[Object]   (_ObjectID)   INDEX IX__tables__ObjectID,
    --
    ...
    CONSTRAINT CPK__tables__DatabaseID__ObjectID PRIMARY KEY CLUSTERED (_DatabaseID, _ObjectID),
